    ...
    >
      <div className="w-full max-w-[420px] rounded-[16px] bg-surface p-6 text-center shadow-[0_30px_80px_rgba(0,0,0,.5)]">
        ...
        <p className="mt-2 text-[14.5px] leading-[1.5] text-fg">
          Tu caso quedó marcado para revisión prioritaria. Un médico te contactará lo antes posible al
          celular o al correo que registraste al inicio — mantente pendiente de ambos. Vamos a terminar la
          sesión.
        </p>
        <button
          type="button"
